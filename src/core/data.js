		...
		list: [
			{
				...
				html: `<h1>dashboard doesnt exist yet</h1>`,
			},
			{
				title: 'Inventory',
				svgIcon: `<svg
				...
				html: `<h1>inventory doesnt exist yet</h1>`,
			},
			{
				title: 'Analytics',
				svgIcon: `<svg
			...
			},
			{
				...
				html: `<h1>customers doesnt exist yet</h1>`,
			},
		],
	},
	{
		...
		list: [
			{
				...
				html: `<h1>messages doesnt exist yet</h1>`,
			},

			{
				...
				html: `<h1>settings doesnt exist yet</h1>`,
			},
			{
				title: 'Help Centre',
				svgIcon: `<svg
				...
				html: `<h1>help center doesnt exist yet</h1>`,
			},
		],
	},
];
