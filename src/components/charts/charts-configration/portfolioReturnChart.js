...
export function renderPortfolioReturnChart() {
	const data = analyticData.metrics.overview.portfolioReturn;
	const dataColor = '#b9fd60';

	const ctx = document
		.getElementById('portfolio-return-chart')
		.getContext('2d');
	...
	const myChart = new Chart(ctx, {
		...
		data: {
			...
			datasets: [
				{
					data: [data.lastMonth.percentage, data.percentage],
